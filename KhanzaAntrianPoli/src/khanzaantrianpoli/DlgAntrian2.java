 ...
 * @author perpustakaan
 */
public class DlgAntrian2 extends javax.swing.JDialog implements ActionListener {

    private Connection koneksi = koneksiDB.condb();
    private final Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
    private SimpleDateFormat tanggalFormat = new SimpleDateFormat("yyyy-MM-dd");
    private SimpleDateFormat jamFormat = new SimpleDateFormat("HH:mm:ss");
     ...
     * @param modal
     */
    public DlgAntrian2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Antrian Poli Rspw");
...
//        }
        if (Unit1.getText().equals("") && Dokter1.getText().equals("")) {
    ...
    private DlgMutasiBerkas mutber = new DlgMutasiBerkas(null, false);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBackground(new java.awt.Color(0, 51, 204));
        ...
        internalFrame1.setForeground(new java.awt.Color(0, 0, 255));
        ...
        panelisi2.add(jLabel2);
        jLabel2.setBounds(290, 10, 160, 16);
        ...
        panelisi5.add(button2);

        BtnBatal1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/upload24.png"))); // NOI18N
        BtnBatal1.setMnemonic('8');
        BtnBatal1.setText("Mulai");
...
private void BtnSeek5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek5ActionPerformed
    ...
    private void button1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button1MouseClicked
        if (tabMode1.getRowCount() != 0) {
            ...
            mutber.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            mutber.setLocationRelativeTo(internalFrame1);
            mutber.setAlwaysOnTop(false);
            mutber.setVisible(false);
            mutber.setJudul("::[ Mutasi Berkas Rekam Medis ]::", "monitoringberkas/pages");
            try {
                mutber.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":80/khanzarspw/" + "public/pusher/cal.php?no_rawat=" + tabMode1.getValueAt(0, 3).toString() + "_" + tabMode1.getValueAt(0, 2).toString() + "_" + Unit1.getText() + "_" + tabMode1.getValueAt(0, 0).toString() + "_" + Dokter1.getText() + "");
            } catch (Exception ex) {
                System.out.println("Notifikasi : " + ex);
            }

            labelantri1.setText(tabMode1.getValueAt(0, 3).toString() + "_" + tabMode1.getValueAt(0, 2).toString() + "_" + Unit1.getText() + "_" + tabMode1.getValueAt(0, 0).toString() + "_" + Dokter1.getText());
            labelpas1.setText(tabMode1.getValueAt(0, 2).toString());
            norawat1.setText(tabMode1.getValueAt(0, 3).toString());
            labeldokter1.setText(tabMode1.getValueAt(0, 4).toString());
            date = new Date();
            Sequel.menyimpan("side_db.temp_antrian", "?,?,?,?,?,?,?,?", "antrian", 8, new String[]{jLabel2.getText(), tabMode1.getValueAt(0, 0).toString(), tanggalFormat.format(date), jamFormat.format(date), Unit1.getText(), tabMode1.getValueAt(0, 3).toString(), tabMode1.getValueAt(0, 2).toString(), "no"});
            Sequel.queryu("update reg_periksa set stts='Sudah' where no_rawat='" + tabMode1.getValueAt(0, 3).toString() + "'");
    ...
    private void button2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_button2MouseClicked
        if (!labelantri1.getText().equals("")) {
            ...
            mutber.setJudul("::[ Mutasi Berkas Rekam Medis ]::", "monitoringberkas/pages");
            try {
                mutber.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":80/khanzarspw/" + "public/pusher/cal.php?no_rawat=" + labelantri1.getText() + "");
            } catch (Exception ex) {
                System.out.println("Notifikasi : " + ex);
            }
        }
    ...
    private void BtnBatal1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatal1ActionPerformed
        if (!Unit1.getText().equals("") && !Dokter1.getText().equals("")) {
            ...
            jLabel2.setText(String.valueOf(timestamp.getTime()));
            Sequel.menyimpan("side_db.temp_poli", "?,?,?,?,?,?", "poli", 6, new String[]{Unit1.getText(), Dokter1.getText(), jamFormat.format(date), tanggalFormat.format(date), "mulai", jLabel2.getText()});
            ...
            mutber.setJudul("::[ Mutasi Berkas Rekam Medis ]::", "monitoringberkas/pages");
            try {
                mutber.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":80/khanzarspw/" + "public/pusher/cal.php");
            } catch (Exception ex) {
                System.out.println("Notifikasi : " + ex);
            }
            ...
            TrayIcon trayIcon = new TrayIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/picture/addressbook-edit24.png")));
            PopupMenu popmenu = new PopupMenu();

            MenuItem open = new MenuItem("Show " + Unit1.getText().toLowerCase());
            MenuItem exit = new MenuItem("Tutup " + Unit1.getText().toLowerCase());
            MenuItem operasi = new MenuItem("Dokter Sedang Operasi");
            
            exit.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    Sequel.queryu("update side_db.temp_poli set status='selesai' where poli='" + Unit1.getText() + "' and dokter='" + Dokter1.getText() + "' and tanggal='" + tanggalFormat.format(date) + "' and sesion='" + jLabel2.getText() + "'");
                    System.out.println("Selesai" + tanggalFormat.format(date) + " " + jamFormat.format(date));
            ...
            operasi.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    Sequel.queryu("update side_db.temp_poli set status='Sedang Operasi' where poli='" + Unit1.getText() + "' and dokter='" + Dokter1.getText() + "' and tanggal='" + tanggalFormat.format(date) + "' and sesion='" + jLabel2.getText() + "'");
                    System.out.println("Sedang Operasi" + tanggalFormat.format(date) + " " + jamFormat.format(date));
            ...
            open.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    System.out.println("tampilkan window");
                    setVisible(true);
                }
            });
            ...
            try {
                ...
                Logger.getLogger(DlgAntrian2.class.getName()).log(Level.SEVERE, null, ex);
            }

        } else {
            System.out.println("gagal regis poli");
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                DlgAntrian2 dialog = new DlgAntrian2(new javax.swing.JFrame(), true);
    ...
    private void tampil1() {
        ...
        try {
            ResultSet rs = koneksi.createStatement().executeQuery("select reg_periksa.no_reg,reg_periksa.no_rkm_medis, "
                    ...
                    + "and reg_periksa.stts='Belum' and dokter.nm_dokter='" + Dokter1.getText() + "' "
